...
def main():
    ...
    if not DEPLOY_TOKEN:
        ...
        print('Set it before deploying: export DEPLOY_TOKEN="your_long_token_from_vps_env"')
        sys.exit(1)
